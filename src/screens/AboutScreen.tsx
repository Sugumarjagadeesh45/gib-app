...
<>
  ...
  <View style={styles.row}>
    <Icon name="map" size={18} color="#777" style={styles.icon} />
...
<Icon name="location-outline" size={20} color="#555" style={styles.icon1} />


    <Text style={styles.labelText1}>Location Map:</Text>
    {selectedUser.map_url ? (
      <TouchableOpacity onPress={() => Linking.openURL(selectedUser.map_url || '')}>
        <Text style={[styles.modalText, { color: 'green', textDecorationLine: 'none',backgroundColor:'#fff', padding:10,borderRadius:8, }]}>
          View on Map
        </Text>
      </TouchableOpacity>
    ) : (
      <Text style={styles.modalText1}>N/A</Text>
    )}
  </View>
</>
                  )}
